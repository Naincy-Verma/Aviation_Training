...
@section('content')
                            ...
                            <div class="tab-pane fade" id="private-jet" role="tabpanel"
                                ...
                                <div class="overview-item">
                                    <div class="overview-thumb">
                                        <img src="{{asset('assets/images/aviation/home_page/jet/jet1.png')}}" alt="overview">
    ...
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        ...
        Start About
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <section class="about-section bg-overlay-base ptb-120 bg_img" data-background="{{asset('assets/images/aviation/home_page/jet/jet3.png')}}">
                        ...
                        <div class="charter-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="charter-item">
                                        <div class="charter-thumb">
                                            <img src="{{asset('assets/images/aviation/home_page/deal/deal1.png')}}" alt="charter">
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="charter-item">
                                        <div class="charter-thumb">
                                            <img src="{{asset('assets/images/aviation/home_page/deal/deal2.png')}}" alt="charter">
                                        </div>
                                        <div class="charter-content">
                                ...
                                <div class="swiper-slide">
                                    <div class="charter-item">
                                        <div class="charter-thumb">
                                            <img src="{{asset('assets/images/aviation/home_page/deal/deal3.png')}}" alt="charter">
                                        </div>
                                        <div class="charter-content">
                                ...
                                <div class="swiper-slide">
                                    <div class="charter-item">
                                        <div class="charter-thumb">
                                            <img src="{{asset('assets/images/aviation/home_page/deal/deal4.png')}}" alt="charter">
                                        </div>
                                        <div class="charter-content">
